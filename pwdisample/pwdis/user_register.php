...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        echo "Error: User with the provided email/username already exists.";
    } else {
        // Handle file upload
        if (isset($_FILES['image_upload'])) {
            $uploadDir = 'uploads/';
            $image_upload = $uploadDir . basename($_FILES['image_upload']['name']);
            ...
            echo "Error: File input 'image_upload' not found.";
            exit;
        }
        ...
        if (!password_verify($confirm_password, $password)) {
            ...
            $query = "INSERT INTO users (FirstName, LastName, Gender, Age, Barangay, blk_lot, Email, username, MobileNumber, password, image_upload) VALUES ('$FirstName', '$LastName', '$Gender', $Age, '$Barangay', '$blk_lot', '$Email', '$username', '$MobileNumber', '$password', '$image_upload')";
...
<body>
    <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <h4>Upload Valid ID / PWD ID</h4>
            <div class="row mb-3">
                <div class="col-md-12">
                    <input type="file" name="image_upload" id="image_upload" accept="image/jpeg, image/jpg">
                </div>
            </div>
